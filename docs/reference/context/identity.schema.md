...
|----------|------|----------|------------|
| [@id](#@id) | `string` | Optional. Either namespace and id or xid attribute is required  | Identity (this schema) |
| [xdm:namespace](#xdmnamespace) | Namespace | Optional. Either namespace and id or xid attribute is required | Identity (this schema) |
| [xdm:primary](#xdmprimary) | `boolean` | Optional | Identity (this schema) |
| [xdm:xid](#xdmxid) | `string` | Optional. Either namespace and id or xid attribute is required | Identity (this schema) |
...
`@id`
* Optional. Is required if identity is specified as a combination of namespace and id. Either namespace and id or xid attribute is required
* type: `string`
...
`xdm:xid`
* Optional. Is required if identity is specified as a native XID. Either namespace and id or xid attribute is required
* type: `string`
* defined in this schema
